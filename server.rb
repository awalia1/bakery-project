...
get "/cookies" do	
	...
	@butter_cookie = Cookie.new("Butter Me Up", "1.50", "9.99", "Enter the buttery world of our buttery cookie.", "butter_cookie.jpg")
	@peanut_butter_cookie = Cookie.new("Nutty Butter", "1.80", "10.99", "Peanut Butter? Peanut butter.", "pb_cookie.jpg")
	@oatmeal_cookie = Cookie.new("Oatis", "1.60", "9.89", "Be healthy and have our oatmeal cookie.", "oatmeal_cookie.jpg")
	@gingerbread_cookie = Cookie.new("Ginger me Timbers", "1.05", "9.59", "It doesn't have to be Christmas for you to bite into our delicious gingerbread cookie", "gb_cookie.jpeg" )
	@snickerdoodle_cookie = Cookie.new("The real Snickers", "1.20", "9.19", "We are not sure about the candy bar but this snickerdoodle cookie will definitely take care of your hunger.", "snickerdoodle_cookie.jpg")
	erb :cookies
end
